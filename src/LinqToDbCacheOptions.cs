...
{
    /// <summary>
    /// Configuration options for <see cref="LinqToDbCache"/>.
    /// </summary>
    public class LinqToDbCacheOptions : IOptions<LinqToDbCacheOptions>
    {
        /// <summary>
        ...
        LinqToDbCacheOptions IOptions<LinqToDbCacheOptions>.Value
        {
            get
            {
                return this;
